...
public class ViewHandler {
     ...
     * @param valor
     */
    public static void setSession(String key, Object valor) {
     ...
     * @return
     */
    public static EventListener<Event> redirectID(final String Key, final PageURIEnum path, final Object id, final PageURIEnum pathComeback) {
     ...
     */
    public static AImage getImage(TipoEvento evento, String nomeImagem, String... params) throws CoreException, IOException {
        AImage imagem = null;
        try {
