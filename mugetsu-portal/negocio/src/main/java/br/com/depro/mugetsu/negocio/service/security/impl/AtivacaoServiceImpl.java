...
import br.com.depro.mugetsu.negocio.dao.security.AtivacaoDAO;
...
public class AtivacaoServiceImpl extends TypezeroGenericServiceImpl<Ativacao, AtivacaoDAO> implements AtivacaoService {
     ...
     */
    public Login gerarAtivacao(Login login) throws ApplicationException {
        Ativacao ativacao =  super.getDAO().salvar(new Ativacao(login));
