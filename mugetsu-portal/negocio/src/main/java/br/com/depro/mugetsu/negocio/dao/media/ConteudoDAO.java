 ...
 */
@Service
public class ConteudoDAO extends TypezeroGenericJPADAO<Conteudo> {
	...
	public List<Conteudo> obterPorMediaId(Long id) throws TransactionBaseException {
		try {
	 ...
	 * @throws TransactionBaseException Caso algum erro ocorra.
	 */
	public List<Conteudo> obterPorMedia(Media media) throws TransactionBaseException {
