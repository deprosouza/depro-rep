...
public class TypezeroCriterionUtils {
	...
	public static void createCriterionBigDecimalBlock(List<Criterion> criterions, TypezeroCriteria criteria, String string) {
		if (criteria.containsKey(string)) {
	...
	public static void createCriterionPeriodoBlock(List<Criterion> criterions, TypezeroCriteria criteria, String incio, String fim, String field) {
		if (criteria.containsKey(incio) && criteria.containsKey(fim)) {
