package br.com.depro.mugetsu.carga.utils;
...
public class ImportacaoUtils {
    ...
    public static Media mergeMedia(Media mo, Media ma) {
    	...
    	for (AlternativeName titulo : ma.getNomes()) {
...
//    	}
    	...
    	mo.getTags().clear();
    	mo.getTags().addAll(ma.getTags());
    	
    	mo.setNomePrincipal(mo.getNomePrincipal());
//    	switch (mo.getFormatoMedia()) {
//    		case ANIME:
//	    		if (mo.getQuantidadeEpisodios() == 0 || ma.getQuantidadeEpisodios() > 0) {
