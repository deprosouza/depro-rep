...
public class NumberUtils {
	 ...
	 * 
	 * @param locale
	 *            um objeto {@link Locale} que representa uma especifica regiao
	 *            geografica, politica ou cultural.
	 * @return {@link NumberFormat} formatado com retorno de numeros com
	 *         separador (.), 2 (dois) digitos e arredondamento contabil.
	 */
	 ...
	 * 
	 * @param bd
	 *            <code>BigDecimal</code> para conversao para
	 *            <code>String</code>.
	 * @param locale
	 *            um objeto {@link Locale} que representa uma especifica regiao
	 *            geografica, politica ou cultural.
	 ...
	 *
	 * @param bd
	 *            {@link BigDecimal} para conversão.
	 * @param numeroCasasDecimais
	 *            numero de casas decimais para formatacao do valor de retorno.
	 * @param locale
	 *            um {@link Locale} que representa uma especifica regiao
	 *            geografica, politica ou cultural.
	 * @return valor formatado de acordo com o numero de casas decimais
	 *         passadas.
	 */
	 ...
	 * @param numeroCasasDecimais
	 *            numero de casas decimais para formatacao do valor de retorno.
	 * @param numeroMaximoCasasInteiras
	 *            numero máximo de casas inteiras para formatacao do valor de
	 *            retorno.
	 * @param locale
	 *            um {@link Locale} que representa uma especifica regiao
	 *            geografica, politica ou cultural.
	 ...
	 * 
	 * @param valor
	 *            <code>BigDecimal</code> para ser configurado.
	 * @return o <code>BigDecimal</code> para ser configurado caso nao seja
	 *         nulo.
	 */
	 ...
	 * 
	 * @param valor
	 *            valor para verificar se e nulo.
	 * @return o proprio valor se nao for nulo ou <code>BigDecimal.ZERO</code>
	 *         se for.
	 */
	...
	/**
	 * Retorna o valor de horas em decimais que esta no tipo
	 * <code>BigDecimal</code> convertido em <code>String</code>.
	 * 
	 * @param horasDecimais
	 *            o valor de horas em decimais que esta no tipo
	...
	/**
	 * Retorna o valor do tipo <code>BigDecimal</code> em porcentagem convertido
	 * para <code>String</code>.<br/>
	 ...
	 *            geografica, politica ou cultural.
	 * @param valor
	 *            valor passado por parametro para conversao.
	 ...
	 * 
	 * @param valor
	 *            valor que desejamos descobrir a diferenca em porcentagem.
	 * @param valorBase
	 *            valor base, ou seja, o valor que representa 100%.
